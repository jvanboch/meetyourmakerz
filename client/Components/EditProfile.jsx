...
function Profile() {
    ...
    useEffect(() => 
    {
		...
		return (
            <div style={{ "display": "flex", height: '100vh', "background-color":"#f3f2ef"}}>
                <div style={{ "border":"solid", "width":"8%"}}><SideBar/></div>
                    <div style={{"padding":"60px", "display":"flex", "flex-direction": "column","gap":"60px"}}>
                        <div style={{ "display": "flex", "justifyContent":"left", height: '300px', "background-color":"white", "border": "2px rgb(0 0 0 / 60%)", "border-radius":"10px"}}>
